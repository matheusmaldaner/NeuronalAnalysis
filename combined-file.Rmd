...
table(df_svm_predictions)
output_directory <- "plots/tables/"
output_file <- paste0(output_directory, "svm_predictions.csv")
write.csv(df_svm_predictions, file = output_file, row.names = FALSE)
...
pheatmap(
  ...
  filename = "plots/heatmaps/ass4_svm.png"  # Specify the file name and format
)
...
top_gene_symbols = most_var_5000[top_indices, 2]
