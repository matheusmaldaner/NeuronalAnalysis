...
required_packages <- c("readr", "AnnotationDbi", "BiocManager", "sessioninfo", "magrittr", "tidyverse", "umap", "cowplot", "ggplot2", "devtools", "gprofiler2", "clusterProfiler", "ggalluvial", "topGO", "cluster", "matrixStats")
